...
import com.emersondantas.cursomc.dto.ClienteNewDTO;
...
import com.emersondantas.cursomc.services.exceptions.AuthorizationException;
...
public class ClienteService {
	...
	public void delete(Integer id) throws ObjectNotFoundException, DataIntegrityException {
		...
		try {
			...
			throw new DataIntegrityException("Não é possível excluir pois há pedidos ralacionadas");
		}
	}
